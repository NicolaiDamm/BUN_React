...
export default function Index() {
  ...
  return (
    <div style={{ justifyContent: 'center'}}>
      <sc.BackgroundDiv style={{ backgroundImage: `url(${getImageFromTag("exploration").imgSource})` }} />
      <sc.ContentDiv>
...
const MyComponent = ( props ) => {
  ...
  let selectedPaintings2;
    ...
    const selectedPaintings = useMemo(() => {
      return Array.from({ length: 3 }, () => getImageFromTag(props.tags));
    }, props.tags);
  ...
  return (
    <div style={{display: "flex", alignItems: "center"}}>
      {!isStartReached ? 
      <sc.LeftInlineSvg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path fill="#fffaef" d="M560.615 802.153 333.847 575.385l226.768-227.153 32.615 32.614-194.154 194.539L593.23 769.538l-32.615 32.615Z"/></sc.LeftInlineSvg>
      :      <></>
    }
      ...
      {!isEndReached ? 
      <sc.RigthInlineSvg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path fill="#fffaef" d="m375.385 802.153-32.615-32.615 194.154-194.153L342.77 380.846l32.615-32.614 226.768 227.153-226.768 226.768Z"/></sc.RigthInlineSvg>
      : null}
    </div>
  );
};
...
//       }
//     },
//     { passive: false } // Add this option to avoid the "passive event listener" error
//   );
// }